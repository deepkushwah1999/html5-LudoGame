window.onload = function () {
    ...
    alert("It took me a month to totally design and make everything work properly i left it a few times that it cannot be completed but fixed all of them finally today \n\n Im planning to make the bot play like John wick.. In my next project i'll try to make a intelligent algorithm for bot that will hunt everypiece making it difficult for the player to win \n\n Click below link to play with AI \n https://code.sololearn.com/WHcDGhYCSDpx/?ref=app \n\n Your 1 upvote will give me soo much confidence 🔥🔥🔥");
    
    
    var newRule = confirm(" NEW RULE (Added on 17th Jan 2022) ::: \n\n You cannot go to the redhome without killing the opponent atleast once but the bot has the power to go as it is weaker than you \n\n Click 'OK' to play with this rule 'Cancel' to play without this rule");
